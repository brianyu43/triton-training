...
- 원인 분해 — autotune (`BLOCK_M/N`, `num_warps`, `num_stages`) + 온라인 softmax + `tl.dot` HW matrix path + paged 의 `(B, H_kv)` grid refactor
...
# Lesson 11 · paged attention correctness (32 shapes × 2 dtypes)
