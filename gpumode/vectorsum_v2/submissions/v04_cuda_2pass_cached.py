...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("vectorsum_forward", &vectorsum_forward, "A100 vectorsum cached 2-pass forward");
}
"""
...
torch::Tensor vectorsum_forward(torch::Tensor x, torch::Tensor output) {
  ...
  partial_sum_kernel<<<g_blocks, kBlockSize, 0, stream>>>(
      x.data_ptr<float>(),
...
"""
    ...
    _EXT = load_inline(
        name="vectorsum_v2_a100_2pass_cached_ext",
        cpp_sources=[cpp_src],
