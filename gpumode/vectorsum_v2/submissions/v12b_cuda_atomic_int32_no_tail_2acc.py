...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("vectorsum_forward", &vectorsum_forward, "A100 vectorsum int32 no-tail 2acc forward");
}
"""
...
__global__ void atomic_sum_kernel(
  ...
  for (; idx + stride < n4; idx += stride * 2) {
    s0 += sum4(x4[idx]);
...
"""
    ...
    _EXT = load_inline(
        name="vectorsum_v2_a100_v12b_int32_2acc_ext",
        cpp_sources=[cpp_src],
