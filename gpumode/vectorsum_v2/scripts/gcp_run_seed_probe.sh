...
LOCAL_LOG="$LOG_DIR/seed_distribution_probe_${STAMP}.out"

REMOTE_ROOT="/home/xavier"
REMOTE_PROJ="$REMOTE_ROOT/cudatraining/gpumode/vectorsum_v2"
REMOTE_SCRIPT="$REMOTE_PROJ/scripts/seed_distribution_probe.py"
...
gcloud compute scp "$ROOT_DIR/gpumode/vectorsum_v2/scripts/seed_distribution_probe.py" \
