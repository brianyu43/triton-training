...
torch::Tensor trimul_v29_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v29_forward", &trimul_v29_forward, "trimul v29 cuda hidden tiled16");
}
"""
...
torch::Tensor trimul_v29_forward(
  ...
  constexpr int kHiddenWarpsPerBlock = 16;
  ...
  if (hidden_dim == 128) {
    ...
    hidden_ln_gate_to_rows_tiled_kernel<128, kHiddenWarpsPerBlock><<<hidden_warp_blocks, kHiddenThreads, hidden_shmem>>>(
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v29_cuda_ext_hidden_tiled16",
        cpp_sources=cpp_src,
