...
torch::Tensor trimul_v32_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v32_forward", &trimul_v32_forward, "trimul v32 cuda c384 warp ln");
}
"""
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v32_cuda_ext_c384_warp_ln",
        cpp_sources=cpp_src,
