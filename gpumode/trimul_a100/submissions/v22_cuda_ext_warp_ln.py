...
torch::Tensor trimul_v22_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v22_forward", &trimul_v22_forward, "trimul v22 cuda warp ln");
}
"""
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v22_cuda_ext_warp_ln",
        cpp_sources=cpp_src,
