...
torch::Tensor trimul_v25_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v25_forward", &trimul_v25_forward, "trimul v25 cuda stage timing");
}
"""
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v25_cuda_ext_stage_timing",
        cpp_sources=cpp_src,
