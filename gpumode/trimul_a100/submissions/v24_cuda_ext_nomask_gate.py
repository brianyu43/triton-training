...
torch::Tensor trimul_v24_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v24_forward", &trimul_v24_forward, "trimul v24 cuda nomask gate");
}
"""
...
torch::Tensor trimul_v24_forward(
  ...
  if (hidden_dim == 128) {
    hidden_ln_gate_to_rows_warp_kernel<128, kHiddenWarpsPerBlock><<<hidden_warp_blocks, ln_threads>>>(
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v24_cuda_ext_nomask_gate",
        cpp_sources=cpp_src,
