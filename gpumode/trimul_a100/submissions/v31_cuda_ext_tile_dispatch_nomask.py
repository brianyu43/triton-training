...
torch::Tensor trimul_v31_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v31_forward", &trimul_v31_forward, "trimul v31 cuda tile dispatch nomask");
}
"""
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v31_cuda_ext_tile_dispatch_nomask",
        cpp_sources=cpp_src,
