...
torch::Tensor trimul_v21_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v21_forward", &trimul_v21_forward, "trimul v21 cuda cache");
}
"""
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v21_cuda_ext_cache",
        cpp_sources=cpp_src,
