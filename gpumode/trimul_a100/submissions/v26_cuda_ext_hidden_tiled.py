...
torch::Tensor trimul_v26_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v26_forward", &trimul_v26_forward, "trimul v26 cuda hidden tiled");
}
"""
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v26_cuda_ext_hidden_tiled",
        cpp_sources=cpp_src,
