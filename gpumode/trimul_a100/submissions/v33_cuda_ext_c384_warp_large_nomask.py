...
torch::Tensor trimul_v33_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v33_forward", &trimul_v33_forward, "trimul v33 cuda c384 warp large nomask");
}
"""
...
torch::Tensor trimul_v33_forward(
  ...
  if (mask.scalar_type() == torch::kFloat32 && n >= 768) {
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v33_cuda_ext_c384_warp_large_nomask",
        cpp_sources=cpp_src,
