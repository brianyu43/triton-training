...
torch::Tensor trimul_v23_forward(
    torch::Tensor x,
    torch::Tensor mask,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("trimul_v23_forward", &trimul_v23_forward, "trimul v23 cuda hidden warp ln");
}
"""
...
"""
    ...
    _EXT = load_inline(
        name="trimul_v23_cuda_ext_hidden_warp_ln",
        cpp_sources=cpp_src,
