...
# Lesson 09 · Phase 4 : torch.library.custom_op integration test on L4.
# Exercises the @custom_op registration + torch.compile(fullgraph=True)
# on a realistic attention block.
...
LOG_PATH="${LOG_DIR}/lesson09-phase4-${STAMP}.log"
...
echo "+++ Phase 4 · custom_op + torch.compile integration test"
$PY triton_kernels/bench/bench_flash_attention_mha_op.py
'
